...
%------------------image_process(first,last,h_cm,fps)---------------------
...
% to cgs units.  The input 'fps' (frames per second) is the rate at which
% the data was collected.
%
% Example: Suppose you want to process all the data for images named
%          'Frame_002.tif' through 'Frame_900.tif', which were collected
%	   at 7.5 fps.  Also, suppose you measured that the real height
%          that an image corresponds to is 4.8cm.  Then, you would type:
%               image_process('0002', '2250', 4.8, 7.5);
%-------------------------------------------------------------------------
